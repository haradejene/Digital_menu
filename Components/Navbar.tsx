    ...
    <nav className="sticky top-0 z-50  ">
      <div className="flex items-center h-24 px-6 md:px-8">
        ...
        <div className="flex-1 flex items-center justify-end space-x-4">
          {/* Order Now Button (Desktop) - FIXED */}
          <Link 
            href="/menu" 
      ...
      {/* Mobile Navigation */}
      {isOpen && (
        <div className="md:hidden border-t border-white/20 bg-gradient-to-r from-[#730202] to-[#B80000]">
          <div className="px-4 pt-4 pb-6 space-y-3">
            ...
            <div className="relative mb-4">
              <input
                type="text"
                placeholder="SEARCH"
                className="bg-transparent text-white placeholder-white/70 focus:outline-none w-full pb-2 pr-10 text-lg"
              />
              {/* Horizontal line */}
              <div className="absolute bottom-0 left-0 w-full h-0.5 bg-white/70"></div>
              {/* Search icon at the end */}
              <FiSearch className="text-white/70 absolute right-0 bottom-2" size={20} />
            </div>
            ...
            {/* Mobile Order Now Button - SIMPLIFIED */}
            <Link 
              href="/menu" 
